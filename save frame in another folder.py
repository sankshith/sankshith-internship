...
def process_video(input_path, output_folder, x, y, width, height):
    # Open the video file
...
input_video_path = "C:\\Users\\DevAppSys Office\\Downloads\\pexels-musa-ortaç-19167598 (1080p).mp4"
output_frames_folder = "F:\\Captures"

# Specify the crop region (x, y, width, height)
x, y, width, height = 100, 100, 200, 200

# Process the video and save cropped frames to the output folder
process_video(input_video_path, output_frames_folder, x, y, width, height)
